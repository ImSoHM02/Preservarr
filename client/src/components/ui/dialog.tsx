...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Overlay ref={ref} className={cn("ui-dialog__overlay", className)} {...props} />
));
...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content ref={ref} className={cn("ui-dialog__content", className)} {...props}>
      {children}
      <DialogPrimitive.Close className="ui-dialog__close-button">
        <X className="ui-dialog__close-icon" />
        <span className="ui-dialog__sr-only">Close</span>
